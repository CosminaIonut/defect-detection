...
def load_all_models(n_models):
    ...
    for i in range(n_models):
        ...
        # filename = '../../trained_models/models_segments_no_overlap-baseline30.0_50epochs/model_' + str(i + 1) + '.h5'
        # filename = '../../trained_models/models_segments_no_overlap-baseline-RMSprop30.0_50epochs/model_' + str(i + 1) + '.h5'
        # filename = '../../trained_models/models_segments_no_overlap-dropout-visiblelayer30.0_50epochs/model_' + str(i + 1) + '.h5'
        # filename = '../../trained_models/models_segments_no_overlap-dropout-hiddenlayer30.0_50epochs/model_' + str(i + 1) + '.h5'
        # filename = '../../trained_models/models_segments_no_overlap-30.0_50epochs/model_' + str(i + 1) + '.h5'
        filename = '../../trained_models/models_segments_no_overlap-30.0_1epochs/model_' + str(i + 1) + '.h5'
...
#
# # savetxt('./train_test_csv/train_no_overlap.csv', X_train, delimiter=',')
# # savetxt('./train_test_csv/train_target_no_overlap.csv', Y_train, delimiter=',')
# # savetxt('./train_test_csv/test_target_no_overlap.csv', Y_test, delimiter=',')
# # savetxt('./train_test_csv/test_no_overlap.csv', X_test, delimiter=',')
#
# # print(X_train)
#
...
# #
# # # # Save plots
# # plt.savefig('../../plots/no_overlap/test.png')
# # # # plt.show()
# #
# #
