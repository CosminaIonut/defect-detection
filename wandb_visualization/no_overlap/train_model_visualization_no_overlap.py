import wandb
from model_training.no_overlap.model_generation_no_overlap import split_data, train_model, build_nn, build_baseline_nn, \
    train_model_k_fold, build_dropout_visible_nn, build_dropout_hidden_nn
...
group = "no-overlap" + "-"+str(epochs)+"epochs"
for i in range(n_members):
    ...
    # save model
    filename = '../../trained_models/models_segments_no_overlap-' + str(test_size*100) + '_'+str(epochs) + 'epochs/model_' + str(i + 1) + '.h5'
